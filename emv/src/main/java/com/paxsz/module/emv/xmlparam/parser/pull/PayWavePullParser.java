    ...
    private void parsePayWaveAid(XmlPullParser parser, PayWaveAid payWaveAid) throws IOException, XmlPullParserException, ParseException {
        ...
        switch (name) {
            ...
            case "CardDataInputCapability":
                payWaveAid.setCardDataInputCapability(convert.strToBcd(parser.nextText(), IConvert.EPaddingPosition.PADDING_LEFT)[0]);
                break;

            case "CVMCapability":
                payWaveAid.setCvmCapability(convert.strToBcd(parser.nextText(), IConvert.EPaddingPosition.PADDING_LEFT)[0]);
                break;
